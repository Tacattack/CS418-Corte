                            ...
                            while ($row = mysqli_fetch_assoc($result))
                            {
                                    ...
                                    $_SESSION["CurrentFreeze"] = $row["questionFrozen"];
                                       ...
                                       echo "<tr>"."<div>";
                                        ...
                                        echo "<td>"."Freeze:";
                                        echo "<form id=\"freeze\" action=\"PHP/Freezing.php?=".$row["questionFrozen"]." method=\"post\">"."<buton form=\"freeze\" name=\"freeze\" type=\"submit\" value=".row["questionFrozen"].">Freeze</button></div>"."</label>"."</form>"."</td>"."</tr>";
                                    echo "</div>"; 
                                    echo "</table>";
                                    }
                                    else
