                            ...
                            while ($row = mysqli_fetch_assoc($result))
                            {
                                    ...
                                    $test2=$row["id"];
                                       ...
                                       echo "<tr>"."<div>";
                                        ...
                                        echo "<form id=\"freeze\" action=\"PHP/Freezing.php?=".$test."&delete=".$test2."method=\"post\">"."<button form=\"freeze\" name=\"freeze\" type=\"submit\" value=".$test.">Freeze</button></div>"."</form>";
                                        echo "</td>"."</tr>";
                                    echo "</div>"; 
                                    echo "</table>";
                                    }
