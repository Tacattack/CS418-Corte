                            ...
                            while ($row = mysqli_fetch_assoc($result))
                            {
                                    ...
                                    $test2=$row["id"];
                                       ...
                                       echo "<tr>"."<div>";
                                        ...
                                        echo "<form id=\"freeze\" action=\"PHP/Freezing.php?=".$test."method=\"post\">"."<button form=\"freeze\" name=\"freeze\" type=\"submit\" value=".$test." data-name=\"deletes\" data-value=deletes=".$test2.">Freeze</button></div>"."</form>";
                                        echo "</td>"."</tr>";
                                    echo "</div>"; 
                                    echo "</table>";
                                    }
