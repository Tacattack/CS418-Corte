            ...
            <?php
                if (isset($_SESSION["USER"]))
                {
                    ...
                    if(isset($_POST["submit"])){
                        $QuestionTitle = mysqli_real_escape_string(addslashes($_POST['QTitle']));
                        $QuestionBody = mysqli_real_escape_string(addslashes($_POST['QBody']));
                        $QuestionPoster = $_SESSION["USER"];
                        $QuestionTagOne = mysqli_real_escape_string(addslashes($_POST['tagOne']));
                        $QuestionTagTwo = mysqli_real_escape_string(addslashes($_POST['tagTwo']));
                        $QuestionTagThree = mysqli_real_escape_string(addslashes($_POST['tagThree']));
